...
public class WolfMountModel extends AgeableModel<MountEntity> {
    ...
    public void setupAnim(MountEntity mount, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
        this.head.xRot = p_225597_6_ * ((float)Math.PI / 180F);
        this.head.yRot = p_225597_5_ * ((float)Math.PI / 180F);

        // set tail angle based on health like vanilla
        float health = 1 - (mount.getHealth() / mount.getMaxHealth());
        this.tail.xRot = 1.25F - Math.min(health, 0.8F);
    }
}