...
public class IronGolemMountModel extends SegmentedModel<MountEntity> {
    ...
    public void prepareMobModel(MountEntity p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
        int i = 0; // p_212843_1_.getAttackAnimationTick();
        if (i > 0) {
            ...
            int j = 0; // p_212843_1_.getOfferFlowerTick();
            if (j > 0) {
