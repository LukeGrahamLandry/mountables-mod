...
public class DrownedLayer extends LayerRenderer<MountEntity, ZombieMountModel> {
    ...
    private final ZombieMountModel model = new ZombieMountModel(0.25F, 0.0F, 64, 64);

    public DrownedLayer(IEntityRenderer<MountEntity, ZombieMountModel> p_i50943_1_) {
        super(p_i50943_1_);
    }
    ...
    public void render(MatrixStack p_225628_1_, IRenderTypeBuffer p_225628_2_, int p_225628_3_, MountEntity mount, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
        if (mount.getTextureType() == 2) coloredCutoutModelCopyLayerRender(this.getParentModel(), this.model, DROWNED_OUTER_LAYER_LOCATION, p_225628_1_, p_225628_2_, p_225628_3_, mount, p_225628_5_, p_225628_6_, p_225628_8_, p_225628_9_, p_225628_10_, p_225628_7_, 1.0F, 1.0F, 1.0F);
    }
}