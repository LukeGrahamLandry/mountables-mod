...
public class SkeletonMountModel extends BipedModel<MountEntity> {
    public SkeletonMountModel() {
        this(0.0F, false);
    }

    public SkeletonMountModel(float p_i46303_1_, boolean p_i46303_2_) {
        super(p_i46303_1_);
        if (!p_i46303_2_) {
