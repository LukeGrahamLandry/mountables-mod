...
public class RavagerMountModel extends SegmentedModel<MountEntity> {
    ...
    public void prepareMobModel(MountEntity p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
        ...
        int i = 0; // p_212843_1_.getStunnedTick();
        int j = 0; // p_212843_1_.getRoarTick();
        int k = 20;
        int l = 0; // p_212843_1_.getAttackTick();
        int i1 = 10;
        if (l > 0) {
