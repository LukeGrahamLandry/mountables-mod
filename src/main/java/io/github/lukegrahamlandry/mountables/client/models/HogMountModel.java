...
public class HogMountModel extends AgeableModel<MountEntity> {
    ...
    public void setupAnim(MountEntity p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
        this.rightEar.zRot = -0.6981317F - p_225597_3_ * MathHelper.sin(p_225597_2_ / 5);
        this.leftEar.zRot = 0.6981317F + p_225597_3_ * MathHelper.sin(p_225597_2_ / 5);
        this.head.yRot = p_225597_5_ * ((float)Math.PI / 180F);
        int i = 0; // p_225597_1_.getAttackAnimationRemainingTicks();
