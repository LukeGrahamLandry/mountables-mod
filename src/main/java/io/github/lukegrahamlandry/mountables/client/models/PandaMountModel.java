...
public class PandaMountModel extends QuadrupedModel<MountEntity> {
    private float sitAmount;
    private float lieOnBackAmount;
    private float rollAmount;

    public PandaMountModel() {
    ...
    public void prepareMobModel(MountEntity p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
        ...
        this.sitAmount = 0;//p_212843_1_.getSitAmount(p_212843_4_);
        this.lieOnBackAmount = 0;//p_212843_1_.getLieOnBackAmount(p_212843_4_);
        this.rollAmount = 0;//p_212843_1_.isBaby() ? 0.0F : p_212843_1_.getRollAmount(p_212843_4_);
    }
    ...
    public void setupAnim(MountEntity p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
        ...
        boolean flag = false; //p_225597_1_.getUnhappyCounter() > 0;
        boolean flag1 = false; // p_225597_1_.isSneezing();
        int i = 0; // p_225597_1_.getSneezeCounter();
        boolean flag2 = false; // p_225597_1_.isEating();
        boolean flag3 = false;// p_225597_1_.isScared();
        if (flag) {
