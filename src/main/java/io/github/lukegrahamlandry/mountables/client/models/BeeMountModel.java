...
public class BeeMountModel extends AgeableModel<MountEntity> {
    ...
    public void prepareMobModel(MountEntity p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
        ...
        this.rollAmount = 0; // p_212843_1_.getRollAmount(p_212843_4_);
        this.stinger.visible = true; // !p_212843_1_.hasStung();
    }
