...
public class IllagerMountModel extends SegmentedModel<MountEntity> implements IHasArm, IHasHead {
    ...
    public IllagerMountModel(){
        this(0.0F, 0.0F, 64, 64);
    }

    public IllagerMountModel(float p_i47227_1_, float p_i47227_2_, int p_i47227_3_, int p_i47227_4_) {
    ...
    public void setupAnim(MountEntity p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
        ...
        AbstractIllagerEntity.ArmPose abstractillagerentity$armpose = AbstractIllagerEntity.ArmPose.NEUTRAL; // p_225597_1_.getArmPose();
